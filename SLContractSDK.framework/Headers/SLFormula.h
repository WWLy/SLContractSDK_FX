...
+ (NSString *)calculatePositionMMRWithPosition:(BTPositionModel *)position contract:(BTContract *)contract;

#pragma mark - 计算仓位的开仓保证金率
+ (NSString *)calculatePositionIMRWithPosition:(BTPositionModel *)position contract:(BTContract *)contract riskLimit:(BTContractRiskLimitModel *)riskLimit;
#pragma mark - 计算仓位的开仓保证金
+ (NSString *)calculatePositionIMWithPosition:(BTPositionModel *)position riskLimit:(BTContractRiskLimitModel *)riskLimit;
...
+ (NSString *)calculateContractValueWithVol:(NSString *)vol
                                   ...
                                   contract:(BTContract *)contractModel;
...
+ (NSString *)coinToTicket:(NSString *)vol
                     price:(NSString *)price
                  contract:(BTContract *)contract;

#pragma mark - 合约单位转换，将张转成币
+ (NSString *)ticketToCoin:(NSString *)vol
                     price:(NSString *)price
                  contract:(BTContract *)contract;
...
+ (BTContractsModel *)getContractInfoWithContractID:(int64_t)contract_id;

...
@property (nonatomic, strong) NSMutableArray *contractsArr; //合约信息数组
...
+ (ContractOrderSize *)getOpenOrderSizeWithContractID:(int64_t)contract_id;
...
+ (void)getContractsInfoWithContractID:(int64_t)contract_id
                               success:(void (^)(NSArray <BTContractsModel *>*))success
                               failure:(void (^)(NSError *))failure;

// 根据contractID获取用户仓位
+ (void)getUserPositionWithContractID:(int64_t)contract_id
...
// 获取用户订单记录
+ (void)getUserContractOrdersWithContractID:(int64_t)contract_id
...
// 获取用户计划委托记录
+ (void)getUserPlanOrdersOrdersWithContractID:(int64_t)contract_id
                                       status:(BTContractOrderStatus)status
                                       offset:(NSInteger)offset
                                         size:(NSInteger)size
                                      success:(void (^)(NSArray <BTContractOrderModel *>*))success
...
// 获取合约的深度
+ (void)getContractDeapthWithContractID:(int64_t)contract_id
...
+ (void)getContractRecordWithContractID:(int64_t)contract_id
                                success:(void (^)(NSArray <BTContractTradeModel *>*))success
                                failure:(void (^)(NSError *))failure;

// 获取某一个contractID的交易记录
+ (void)getContractUserRecordWithContractID:(int64_t)contract_id
...
// 获得资金流水
+ (void)getCashBooksWithContractID:(int64_t)contract_id
...
// 获得资金费率
+ (void)getFundingrateWithContractID:(int64_t)contract_id
                             success:(void (^)(id result))success
                             failure:(void (^)(id ))failure;

// 获取保险基金记录
+ (void)getRiskReservesWithContractID:(int64_t)contract_id
                              success:(void (^)(NSArray *result))success
                              failure:(void (^)(id ))failure;

// 调整保证金
+ (void)marginDepositWithContractID:(int64_t)contract_id
...
// 获取用户爆仓记录
+ (void)getEserLiqRecordsWithContractID:(int64_t)contract_id
                                orderID:(int64_t)order_id
                                success:(void (^)(id result))success
                                failure:(void (^)(id ))failure;

// 创建合约账户
+ (void)createContractAccountWithContractID:(int64_t)contract_id
                                    success:(void (^)(id result))success
                                    failure:(void (^)(id ))failure;
